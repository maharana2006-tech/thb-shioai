...
public class OrderImportController {
    ...
    public ResponseEntity<ApiResponse<com.multiship.backend.dto.ImportBatchRowsPageDTO>> historyRows(
        ...
        Long id = resolveBatchId(slug).orElse(null);
        com.multiship.backend.dto.ImportBatchRowsPageDTO dto = id == null ? null
                : orderImportService.historyRows(id, view, q, rowNumber, page, size);
        if (dto == null) {
