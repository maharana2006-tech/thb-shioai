...
CREATE TABLE OEHEAD (
  ...
  SHIP_ATTN          VARCHAR2(200),
  SHIP_ADDR1         VARCHAR2(200),
  SHIP_ADDR2         VARCHAR2(200),
  SHIP_ADDR3         VARCHAR2(200),
  SHIPTO_CITY        VARCHAR2(100),
  SHIPTO_STATE       VARCHAR2(50),
  SHIPTO_ZIP         VARCHAR2(20),
  SHIPTO_COUNTRY_CD  VARCHAR2(2),
  SHIPTO_RECIP_PHONE VARCHAR2(40),
