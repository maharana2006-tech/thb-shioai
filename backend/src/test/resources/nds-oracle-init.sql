...
CREATE TABLE OE_SHIP_CONTAINER (
  ...
  ORDER_NO           VARCHAR2(40) NOT NULL,
  ORDER_SUFFIX       VARCHAR2(10) NOT NULL,
  BILLABLE_WEIGHT_LB NUMBER(10, 3),
  LENGTH_IN          NUMBER(10, 3),
  WIDTH_IN           NUMBER(10, 3),
  HEIGHT_IN          NUMBER(10, 3),
  PACKAGE_TYPE_CD    VARCHAR2(40)
);

-- ─── SHIPVIA (CLIENT-login, ship-method description) ─────────
CREATE TABLE SHIPVIA (
  SHIPVIA_CD  VARCHAR2(20) PRIMARY KEY,
...
CREATE TABLE OE_SEND_TO (
  ...
  ORDER_SUFFIX  VARCHAR2(10) NOT NULL,
  EMAIL         VARCHAR2(200),
  EMAIL_LABEL   VARCHAR2(80),
  CONSTRAINT PK_OE_SEND_TO PRIMARY KEY (ORDER_NO, ORDER_SUFFIX, EMAIL)
);
