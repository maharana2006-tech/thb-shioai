...
import { STATE_CODE_OPTIONS, STATE_CODE_SETS } from '../utils/stateCodes'
 ...
 *
 * <p>Non-invasive — only appends to {@code warnings}. Never changes
 * {@code valid} or {@code matchLevel}, because the carrier really did
 * confirm the underlying address (city/street/postal). Only the state
 * shape is off.
 */
